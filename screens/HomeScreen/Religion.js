...
const Religion = () => {
    ...
    const fetchCampusesPost = async () => {
        const { error, posts } = await getCampusesPosts();
    ...
    return (
        <View style={styles.page}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <GoBack />
                <Text style={{ marginLeft: SIZES.h1, ...FONTS.h1, color: COLORS.primary }}><Text style={{ color: COLORS.orange }}>CG </Text>Campuses</Text>
            </View>
